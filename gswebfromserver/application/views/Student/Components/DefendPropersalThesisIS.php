<div class="row" style="text-align:left;margin-top:0%">
  <div class="col-md-12 col-sm-12" style="text-align:center;margin-top:3%">
    ...
    <div class="col-md-3 col-sm-4">
      ...
      <?php echo $_SESSION['LEVELID'] ==82 ? "สอบเค้าโครงการค้นคว้าอิสระ" : "สอบเค้าโครงวิทยานิพนธ์";?>
    </div>
...
<?php if($data['param1'][0] ==1){
  $this->load->view('Student/Page/DefendPropersalThesisISTimeLine1');
}else if($data['param1'][0] ==2){
  $this->load->view('Student/Page/DefendPropersalThesisISTimeLine2');
}else if($data['param1'][0]==3){
  $this->load->view('Student/Page/DefendPropersalThesisISTimeLine3');
}
?>
