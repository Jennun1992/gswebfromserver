						...
						<nav class="main-nav">
							<ul class="main-menu">
								...
								<li <?php echo $menuactive=='5' ? 'class="active"':'' ;?>>
									<a href="<?php echo base_url();?>index.php/Student/propersalThesisIS/" >
									<i class="glyphicon glyphicon-bullhorn"></i><span class="text">ขอสอบเค้าโครงวิทยานิพนธ์</span></a>
								</li>
								<li <echo $menuactive=='7' ? 'class="active"':'' ;?>
									<a href="<echo base_url();?>index.php/Student/searchdisst/" >
									<i class="glyphicon glyphicon-list-alt"></i><span class="text">ขอสอบวิทยานิพนธ์</span></a>
								</li>
								...
								<li <?php echo $menuactive=='9' ? 'class="active"':'' ;?>>
